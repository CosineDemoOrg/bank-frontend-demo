...
export default function Report() {
  ...
  const handleExtraInformationChange = (event: {
    target: { value: SetStateAction<string> };
  }) => {
            ...
            <form className="d-flex flex-column gap-3">
              <dl className="row">
                ...
                <dd className="col-sm-9">
                  kont bagry fe sheben al kom 3nd porto al zawya we hasal henak
                  3awa2 we mashakel babos 3al card bta3y la2eto etsara2 fa yaret
                  te2flo
                </dd>
                ...
                {selectedOption === "option4" && (
                  <div className="mb-2">
                    <label htmlFor="extraInformation" mb-5>
                      Report Reply
                    </label>
                    <input
                      type="text"
